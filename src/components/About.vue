...
import logoResume from '../assets/logoResume.png'
...
const links = [
  ...
  { name: 'Resume', icon: logoResume, url: '/CV.pdf' }
]
...
.card:hover .card-name {
  opacity: 1;
  border-bottom: 2px solid white; /* soulignement */
}
